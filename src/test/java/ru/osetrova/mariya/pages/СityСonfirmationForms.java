...
public class СityСonfirmationForms {
    private SelenideElement
            ...
            yesButton = formSelectQuestion.$("button:first-child"), //элементы внутри родительского элемента https://developer.mozilla.org/en-US/docs/Web/CSS/:nth-child
            noButton = formSelectQuestion.$("[data-role='question.yes']"), // https://htmlbook.ru/css/nth-child
